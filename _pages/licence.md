...
<dl class="license-exceptions">
  ...
  <dd>Dépôt séparé <code>wiki-cap-nature</code> — <a href="https://creativecommons.org/licenses/by-sa/4.0/deed.fr" target="_blank" rel="noopener">Creative Commons Attribution-ShareAlike 4.0 International (CC BY-SA 4.0) ↗</a></dd>

  <dt>Photographies issues de banques d'images libres</dt>
  <dd>Par exemple Unsplash — licences respectives de leurs auteur·ice·s d'origine.</dd>

  <dt>Bibliothèques et frameworks tiers</dt>
  <dd>Jekyll, polices web (EB Garamond, Inter), etc. — sous leurs licences respectives.</dd>
</dl>
